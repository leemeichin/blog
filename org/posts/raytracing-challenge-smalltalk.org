...
And that actually marks the end of the chapter, so I'm gonna call it a day here. Matrices and matric transformations are on the menu tomorrow, so we're back to the mathemology again.
